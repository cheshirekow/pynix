...
const char* g_epoll_ctl_docstr =
    ...
    "\n"
    "int epoll_ctl(int epfd, int op, int fd, uint32_t events, PyObject* "
    "data);\n"
    "\n"
    ...
    "file descriptor and returned on events, but it's reference count will not "
    "be\n"
...
const char* g_mount_docstr =
    ...
    "listed in /proc/filesystems (e.g., \"btrfs\", \"ext4\", \"jfs\", "
    "\"xfs\",\n"
